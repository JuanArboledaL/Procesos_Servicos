...
public class GestorEmail {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String emailEmisor = "juan.arboleda@gmx.es";  // Cuenta completa del emisor
            String passwordEmisor = "PSPIESBelen";  // Codigo de "Contraseñas de aplicacion"


            GestorEmail gestorEmail = new GestorEmail();
            gestorEmail.enviarMensajeTexto(emailEmisor, "rvilbri995@g.educaand.es",
                    "Aviso de entrega de factura", "El importe de la factura"
                    + " es 113,72€", emailEmisor, passwordEmisor);

            gestorEmail.enviarMensajeConAdjunto(emailEmisor, "rvilbri995@g.educaand.es",
                    "Aviso de entrega de factura", "El importe de la factura"
